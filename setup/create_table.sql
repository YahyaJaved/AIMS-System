...
(malicious_transaction xid, number_blocked_tuples int, recovery_time float, avail_time float) without oids;

--------------------------------------------------------------------
drop table if exists blocked_tuples_table_DTQR;
create table blocked_tuples_table_DTQR
(blocked_tuples oid) without oids;

--------------------------------------------------------------------
drop table if exists blocked_tuples_table_AIMS;
create table blocked_tuples_table_AIMS
(blocked_tuples oid, ib int) without oids;
...
-------------- New blocked transactions table -----------------
...
(blocked_tuples_count int, status_timestamp timestamp, malicious_transation xid);
