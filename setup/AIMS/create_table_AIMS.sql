...
(transaction_id bigint, depends_on_transaction bigint,
...
(transaction_id bigint, detection_time_stamp timestamp,res_transaction_id bigint) without oids;


-------------------------------------------------------------
drop table if exists malicious_transactions_table;
create table malicious_transactions_table
(transaction_id bigint, detection_time_stamp timestamp,rec_transaction_id bigint) without oids;
...
(transaction_id bigint, transaction_start_time timestamp, transaction_end_time timestamp) without oids;

------------------------------------------------------------------
drop table if exists blocked_tuples_table;
create table blocked_tuples_table
(blocked_tuples oid, malicious_transaction bigint) without oids;

------------------------------------------------------------------
drop table if exists avail_metric_table;
create table avail_metric_table
(malicious_transaction bigint, number_blocked_tuples int, recovery_time float, avail_time float,detection_timestamp timestamp, end_rec_timestamp timestamp) without oids;
--------------------------------------------------------------------
...
(blocked_tuples oid, malicious_transaction bigint, ib int) without oids;
...
drop table if exists blocked_tuples_table;
create table blocked_tuples_table
(blocked_tuples oid, malicious_transaction bigint, detection_timestamp timestamp, recovery_timestamp timestamp) without oids;
...
(blocked_tuples_count int, status_timestamp timestamp, malicious_transation bigint) without oids;
...
(ib int, malicious_transaction bigint) without oids;

-------------- benign transaction status table ---------

drop table if exists benign_transaction_table;
create table benign_transaction_table
(transaction_id bigint, suspension_time timestamp, resumption_time timestamp) without oids;
...
drop table if exists corrupted_transactions_table_AIMS;
create table corrupted_transactions_table_AIMS
(IDS_transaction bigint, transaction_id bigint, detection_time_stamp timestamp) without oids;

------------------- New repair table, with IDS transaction ------------------------
drop table if exists repair_table_AIMS;
create table repair_table_AIMS
(IDS_transaction bigint, corrupted_tuples_oid oid, mal_commit_time timestamp, corrupted_transactions bigint, relation_name regclass) without oids;
