...
(blocked_tuples oid, malicious_transaction xid, ib int) without oids;
...
drop table if exists blocked_tuples_table_AIMS;
create table blocked_tuples_table_AIMS
(blocked_tuples oid, malicious_transaction xid, detection_timestamp timestamp, recovery_timestamp timestamp, ib int) without oids;
...
(IDS_transaction xid, transaction_id xid, detection_time_stamp timestamp) without oids;

------------------- New repair table, with IDS transaction ------------------------
drop table if exists repair_table_AIMS;
create table repair_table_AIMS
(IDS_transaction xid, corrupted_tuples_oid oid, mal_commit_time timestamp, corrupted_transactions xid, relation_name regclass) without oids;
